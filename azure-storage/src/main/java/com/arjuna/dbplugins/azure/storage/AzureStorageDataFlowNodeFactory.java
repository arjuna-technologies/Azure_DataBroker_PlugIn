...
public class AzureStorageDataFlowNodeFactory implements DataFlowNodeFactory
{
    public AzureStorageDataFlowNodeFactory(String name, Map<String, String> properties)
    {
        _name       = name;
